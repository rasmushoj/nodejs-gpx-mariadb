...
--
-- Host: localhost    Database: running
-- ------------------------------------------------------
...
CREATE TABLE `trackpoints` (
  ...
  `trackId` int(10) NOT NULL DEFAULT '1',
  `gpsPoint` point NOT NULL,
  PRIMARY KEY (`pointId`)
) ENGINE=InnoDB AUTO_INCREMENT=8643 DEFAULT CHARSET=latin1;
...
-- Dump completed on 2014-01-20  8:13:21
